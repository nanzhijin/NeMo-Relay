/* NeMo Flow C API - Auto-generated by cbindgen. Do not edit. */
...
typedef struct Option_NemoFlowCollectorCb Option_NemoFlowCollectorCb;
 ...
 */
typedef NemoFlowStatus (*NemoFlowLlmRequestInterceptCb)(void *user_data,
                                                        const char *name,
                                                        const struct FfiLLMRequest *request,
                                                        const char *annotated_json,
 ...
 */
typedef char *(*NemoFlowLlmExecInterceptCb)(void *user_data,
                                            const char *native_json,
                                            NemoFlowLlmExecNextFn next_fn,
                                            void *next_ctx);
 ...
 */
typedef char *(*NemoFlowToolExecInterceptCb)(void *user_data,
                                             const char *args_json,
                                             NemoFlowToolExecNextFn next_fn,
                                             void *next_ctx);
 ...
 */
NemoFlowStatus nemo_flow_get_handle(struct FfiScopeHandle **out);
 ...
 */
NemoFlowStatus nemo_flow_push_scope(const char *name,
                                    NemoFlowScopeType scope_type,
                                    const struct FfiScopeHandle *parent,
                                    uint32_t attributes,
                                    const char *data_json,
                                    const char *metadata_json,
 ...
 */
NemoFlowStatus nemo_flow_pop_scope(const struct FfiScopeHandle *handle,
 ...
 * call.
 */
NemoFlowStatus nemo_flow_event(const char *name,
                               const struct FfiScopeHandle *parent,
                               const char *data_json,
                               const char *metadata_json,
                               const int64_t *timestamp_unix_micros);
 ...
 */
NemoFlowStatus nemo_flow_scope_register_tool_conditional_execution_guardrail(const char *scope_uuid,
                                                                             const char *name,
                                                                             int32_t priority,
                                                                             NemoFlowToolConditionalCb cb,
                                                                             void *user_data,
 ...
 */
NemoFlowStatus nemo_flow_scope_deregister_tool_conditional_execution_guardrail(const char *scope_uuid,
                                                                               const char *name);
 ...
 */
NemoFlowStatus nemo_flow_scope_register_tool_execution_intercept(const char *scope_uuid,
                                                                 const char *name,
                                                                 int32_t priority,
 ...
 * `scope_uuid` and `name` must be valid C strings.
 */
NemoFlowStatus nemo_flow_scope_deregister_tool_execution_intercept(const char *scope_uuid,
                                                                   const char *name);
 ...
 * `scope_uuid` and `name` must be valid C strings. `cb` must be a valid function pointer.
 */
NemoFlowStatus nemo_flow_scope_register_llm_sanitize_request_guardrail(const char *scope_uuid,
                                                                       const char *name,
                                                                       int32_t priority,
                                                                       NemoFlowLlmRequestCb cb,
                                                                       void *user_data,
 ...
 * `scope_uuid` and `name` must be valid C strings.
 */
NemoFlowStatus nemo_flow_scope_deregister_llm_sanitize_request_guardrail(const char *scope_uuid,
                                                                         const char *name);
 ...
 * `scope_uuid` and `name` must be valid C strings. `cb` must be a valid function pointer.
 */
NemoFlowStatus nemo_flow_scope_register_llm_sanitize_response_guardrail(const char *scope_uuid,
                                                                        const char *name,
                                                                        int32_t priority,
                                                                        NemoFlowJsonCb cb,
                                                                        void *user_data,
 ...
 * `scope_uuid` and `name` must be valid C strings.
 */
NemoFlowStatus nemo_flow_scope_deregister_llm_sanitize_response_guardrail(const char *scope_uuid,
                                                                          const char *name);
 ...
 * `scope_uuid` and `name` must be valid C strings. `cb` must be a valid function pointer.
 */
NemoFlowStatus nemo_flow_scope_register_llm_conditional_execution_guardrail(const char *scope_uuid,
                                                                            const char *name,
                                                                            int32_t priority,
                                                                            NemoFlowLlmConditionalCb cb,
                                                                            void *user_data,
 ...
 * `scope_uuid` and `name` must be valid C strings.
 */
NemoFlowStatus nemo_flow_scope_deregister_llm_conditional_execution_guardrail(const char *scope_uuid,
                                                                              const char *name);
 ...
 * `scope_uuid` and `name` must be valid C strings. `cb` must be a valid function pointer.
 */
NemoFlowStatus nemo_flow_scope_register_llm_request_intercept(const char *scope_uuid,
                                                              const char *name,
                                                              int32_t priority,
                                                              bool break_chain,
                                                              NemoFlowLlmRequestInterceptCb cb,
 ...
 * `scope_uuid` and `name` must be valid C strings.
 */
NemoFlowStatus nemo_flow_scope_deregister_llm_request_intercept(const char *scope_uuid,
                                                                const char *name);
 ...
 * `scope_uuid` and `name` must be valid C strings. Callback pointers must be valid.
 */
NemoFlowStatus nemo_flow_scope_register_llm_execution_intercept(const char *scope_uuid,
                                                                const char *name,
                                                                int32_t priority,
                                                                NemoFlowLlmExecInterceptCb exec_cb,
                                                                void *exec_user_data,
 ...
 * `scope_uuid` and `name` must be valid C strings.
 */
NemoFlowStatus nemo_flow_scope_deregister_llm_execution_intercept(const char *scope_uuid,
                                                                  const char *name);
 ...
 * `scope_uuid` and `name` must be valid C strings. Callback pointers must be valid.
 */
NemoFlowStatus nemo_flow_scope_register_llm_stream_execution_intercept(const char *scope_uuid,
                                                                       const char *name,
                                                                       int32_t priority,
                                                                       NemoFlowLlmExecInterceptCb exec_cb,
                                                                       void *exec_user_data,
 ...
 * `scope_uuid` and `name` must be valid C strings.
 */
NemoFlowStatus nemo_flow_scope_deregister_llm_stream_execution_intercept(const char *scope_uuid,
                                                                         const char *name);
 ...
 * `scope_uuid` and `name` must be valid C strings. `cb` must be a valid function pointer.
 */
NemoFlowStatus nemo_flow_scope_register_subscriber(const char *scope_uuid,
                                                   const char *name,
                                                   NemoFlowEventSubscriberCb cb,
                                                   void *user_data,
                                                   NemoFlowFreeFn free_fn);
 ...
 * undefined behavior.
 */
void nemo_flow_string_free(char *ptr);
 ...
 * pointer.
 */
const char *nemo_flow_last_error(void);
 ...
 */
void nemo_flow_set_last_error_message(const char *msg);
 ...
 */
void nemo_flow_scope_handle_free(struct FfiScopeHandle *ptr);
 ...
 * `ptr` must be a valid pointer returned by an `nemo_flow_*` function, or null.
 */
void nemo_flow_tool_handle_free(struct FfiToolHandle *ptr);
 ...
 * `ptr` must be a valid pointer returned by an `nemo_flow_*` function, or null.
 */
void nemo_flow_llm_handle_free(struct FfiLLMHandle *ptr);
 ...
 * `ptr` must be a valid pointer returned by an `nemo_flow_*` function, or null.
 */
void nemo_flow_llm_request_free(struct FfiLLMRequest *ptr);
 ...
 * `ptr` must be a valid pointer returned by an `nemo_flow_*` function, or null.
 */
void nemo_flow_event_free(struct FfiEvent *ptr);
 ...
 */
void nemo_flow_scope_stack_free(struct FfiScopeStack *ptr);
 ...
 */
void nemo_flow_otel_subscriber_free(struct FfiOpenTelemetrySubscriber *ptr);
 ...
 */
void nemo_flow_openinference_subscriber_free(struct FfiOpenInferenceSubscriber *ptr);
 ...
 */
char *nemo_flow_scope_handle_uuid(const struct FfiScopeHandle *ptr);
 ...
 * `ptr` must be a valid `FfiScopeHandle` pointer or null.
 */
char *nemo_flow_scope_handle_name(const struct FfiScopeHandle *ptr);
 ...
 * `ptr` must be a valid `FfiScopeHandle` pointer or null.
 */
NemoFlowScopeType nemo_flow_scope_handle_scope_type(const struct FfiScopeHandle *ptr);
 ...
 * `ptr` must be a valid `FfiScopeHandle` pointer or null.
 */
uint32_t nemo_flow_scope_handle_attributes(const struct FfiScopeHandle *ptr);
 ...
 * `ptr` must be a valid `FfiScopeHandle` pointer or null.
 */
char *nemo_flow_scope_handle_parent_uuid(const struct FfiScopeHandle *ptr);
 ...
 * `ptr` must be a valid `FfiScopeHandle` pointer or null.
 */
char *nemo_flow_scope_handle_data(const struct FfiScopeHandle *ptr);
 ...
 * `ptr` must be a valid `FfiScopeHandle` pointer or null.
 */
char *nemo_flow_scope_handle_metadata(const struct FfiScopeHandle *ptr);
 ...
 */
char *nemo_flow_tool_handle_uuid(const struct FfiToolHandle *ptr);
 ...
 * `ptr` must be a valid `FfiToolHandle` pointer or null.
 */
char *nemo_flow_tool_handle_name(const struct FfiToolHandle *ptr);
 ...
 * `ptr` must be a valid `FfiToolHandle` pointer or null.
 */
uint32_t nemo_flow_tool_handle_attributes(const struct FfiToolHandle *ptr);
 ...
 * `ptr` must be a valid `FfiToolHandle` pointer or null.
 */
char *nemo_flow_tool_handle_parent_uuid(const struct FfiToolHandle *ptr);
 ...
 */
char *nemo_flow_llm_handle_uuid(const struct FfiLLMHandle *ptr);
 ...
 * `ptr` must be a valid `FfiLLMHandle` pointer or null.
 */
char *nemo_flow_llm_handle_name(const struct FfiLLMHandle *ptr);
 ...
 * `ptr` must be a valid `FfiLLMHandle` pointer or null.
 */
uint32_t nemo_flow_llm_handle_attributes(const struct FfiLLMHandle *ptr);
 ...
 * `ptr` must be a valid `FfiLLMHandle` pointer or null.
 */
char *nemo_flow_llm_handle_parent_uuid(const struct FfiLLMHandle *ptr);
 ...
 */
struct FfiLLMRequest *nemo_flow_llm_request_new(const char *headers_json, const char *content_json);
 ...
 */
char *nemo_flow_llm_request_headers(const struct FfiLLMRequest *ptr);
 ...
 * `ptr` must be a valid `FfiLLMRequest` pointer or null.
 */
char *nemo_flow_llm_request_content(const struct FfiLLMRequest *ptr);
 ...
 */
char *nemo_flow_event_uuid(const struct FfiEvent *ptr);
 ...
 * `ptr` must be a valid `FfiEvent` pointer or null.
 */
char *nemo_flow_event_name(const struct FfiEvent *ptr);
 ...
 * `ptr` must be a valid `FfiEvent` pointer or null.
 */
char *nemo_flow_event_atof_version(const struct FfiEvent *ptr);
 ...
 * `ptr` must be a valid `FfiEvent` pointer or null.
 */
char *nemo_flow_event_scope_category(const struct FfiEvent *ptr);
 ...
 * `ptr` must be a valid `FfiEvent` pointer or null.
 */
char *nemo_flow_event_category(const struct FfiEvent *ptr);
 ...
 * `ptr` must be a valid `FfiEvent` pointer or null.
 */
char *nemo_flow_event_attributes_json(const struct FfiEvent *ptr);
 ...
 * `ptr` must be a valid `FfiEvent` pointer or null.
 */
char *nemo_flow_event_data_schema(const struct FfiEvent *ptr);
 ...
 * `ptr` must be a valid `FfiEvent` pointer or null.
 */
uint32_t nemo_flow_event_attributes(const struct FfiEvent *ptr);
 ...
 * `ptr` must be a valid `FfiEvent` pointer or null.
 */
char *nemo_flow_event_data(const struct FfiEvent *ptr);
 ...
 * `ptr` must be a valid `FfiEvent` pointer or null.
 */
char *nemo_flow_event_metadata(const struct FfiEvent *ptr);
 ...
 * `ptr` must be a valid `FfiEvent` pointer or null.
 */
char *nemo_flow_event_timestamp(const struct FfiEvent *ptr);
 ...
 * `ptr` must be a valid `FfiEvent` pointer or null.
 */
char *nemo_flow_event_input(const struct FfiEvent *ptr);
 ...
 * `ptr` must be a valid `FfiEvent` pointer or null.
 */
char *nemo_flow_event_output(const struct FfiEvent *ptr);
 ...
 * `ptr` must be a valid `FfiEvent` pointer or null.
 */
char *nemo_flow_event_model_name(const struct FfiEvent *ptr);
 ...
 * `ptr` must be a valid `FfiEvent` pointer or null.
 */
char *nemo_flow_event_tool_call_id(const struct FfiEvent *ptr);
 ...
 * `ptr` must be a valid `FfiEvent` pointer or null.
 */
char *nemo_flow_event_parent_uuid(const struct FfiEvent *ptr);
 ...
 * `ptr` must be a valid `FfiEvent` pointer or null.
 */
char *nemo_flow_event_scope_type(const struct FfiEvent *ptr);
 ...
 * `ptr` must be a valid `FfiEvent` pointer or null.
 */
char *nemo_flow_event_annotated_request(const struct FfiEvent *ptr);
 ...
 * `ptr` must be a valid `FfiEvent` pointer or null.
 */
char *nemo_flow_event_annotated_response(const struct FfiEvent *ptr);
