...
Refer to [Exporter Selection](/observability-plugin/about#exporter-selection),
[OpenTelemetry](/observability-plugin/opentelemetry),
[OpenInference](/observability-plugin/openinference), and
...
Refer to [Define a Plugin](/build-plugins/basic-guide) and
...
Refer to [Adaptive](/adaptive-plugin/about),
...
Refer to [Framework Integration Code Examples](/integrate-into-frameworks/code-examples#quickstart-apply-maintained-patches)
